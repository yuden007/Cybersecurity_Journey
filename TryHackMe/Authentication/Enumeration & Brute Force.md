# TASK 3: Enumerating User via Verbose Error

Get gmail list from https://github.com/nyxgeek/username-lists/blob/master/usernames-top100/usernames_gmail.com.txt.
Run the python code.
...
Make a password reset with admin@admin.com.
Hint: http://enum.thm/labs/predictable_tokens/reset_password.php?token=123
Try payload of 100~200 in Burp Suite.
Response with different length has the flag.
