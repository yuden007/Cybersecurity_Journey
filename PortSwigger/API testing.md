...
Brute-force username=administrator%26field=§x§%23 with "Server-side variable names" as payload.
The 200 response shows "email" is a valid field type.
This means 200 response is a baseline for validity check, although we can skip "email" and use "username" to get this baseline directly.
